...
<!-- https://tinyurl.com/odsc-mapping -->
...
fake_exercise_data <- read.csv(here::here('Data', "fake_exercise_data.csv"))
...
addPolygons(data = philadelphiaCensusTracts,
  ...
  #addCircles behaves different than addCircleMarks -or something like that-, one zooms the other doesn't.
